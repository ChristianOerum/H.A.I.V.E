...
import { Shape, BoxGeometry, ExtrudeGeometry, SphereGeometry, CircleGeometry, Vector2, BufferGeometry, Float32BufferAttribute, MeshBasicMaterial, MeshDepthMaterial, Mesh } from 'three'
